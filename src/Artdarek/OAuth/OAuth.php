...
class OAuth {
	...
	{
		// if config/oauth-laravel.php exists use this one
		if ( Config::get('oauth-laravel.consumers') != null ) {

			$this->_storage_name = Config::get('oauth-laravel.storage', 'Session');
			$this->_client_id = Config::get("oauth-laravel.consumers.$service.client_id");
			$this->_client_secret = Config::get("oauth-laravel.consumers.$service.client_secret");
			$this->_scope = Config::get("oauth-laravel.consumers.$service.scope", array() );
